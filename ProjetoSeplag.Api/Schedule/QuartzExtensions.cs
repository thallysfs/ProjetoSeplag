...
{
    // https://dejanstojanovic.net/aspnet/2018/august/background-working-scheduled-task-in-aspnet-core-mvc-application/
    public static class QuartzExtensions
    {
        public static void AddQuartz(this IServiceCollection services, Type jobType)
        {
            ...
            services.AddSingleton<ITrigger>(provider =>
            {
                ...
                .WithSimpleSchedule
                 (s =>
                    s.WithInterval(TimeSpan.FromSeconds(300)) //5 min
                    .RepeatForever()
                 )
                 .Build();
            });
